...
class TestGetAllPacketsWithValueContained:
    def test_with_none_for_pcap(self):
        retval = pcap_util.get_all_packets_with_value_contained(None,
                                                                'tcp')

        assert retval is None

    def test_with_none_for_value(self):
        retval = pcap_util.get_all_packets_with_value_contained(tests.pcap,
                                                                None)

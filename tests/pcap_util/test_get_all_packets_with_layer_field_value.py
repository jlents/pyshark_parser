...
class TestGetAllPacketsWithLayerFieldValue:
    def test_with_none_for_pcap(self):
        retval = pcap_util.get_all_packets_with_layer_field_value(None,
                                                                  'tcp',
                                                                  'tcp.srcport',
                                                                  '35301')
    ...
    def test_with_none_for_layer(self):
        retval = pcap_util.get_all_packets_with_layer_field_value(tests.pcap,
                                                                  None,
                                                                  'tcp.srcport',
                                                                  '35301')
